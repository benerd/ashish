 ...
 ?>
	...
	<!-- main-slider -->
		...
		?>			
                           ...
                           <p>
<?php echo substr($data["short_des"], 0, 120);  ?></p>
...
<a href="<?php echo $url; ?>" class="anchor1" style="    width: 197px;
    ...
    text-decoration: none;"> Read More...</a>
								...
								<div class="img-hov"> <img src="<?php echo $data['image']; ?>" width="100%" height="450px"> </div>
							</div>
		...
		?>				
						...
						<div class="container">
								...
								<?php 	if($i==1){  ?><div class="shape1">
										...
										<img src="<?php echo $data["d_image"]; ?>" width="100%" style="height: 350px;" height="350px" class="img-responsive">
									</div>
									<div class="col-md-6 mar">
									<h2 style="font-family: 'Great Vibes', cursive;color: black;text-transform: capitalize; font-size: 36px;"><?php echo $data['category']; ?></h2>
									<h1 style="text-align: center;"> <a  style="color: black;" href="<?php echo $url; ?>">	<?php echo $data["heading"]; ?> </a>
									</h1><br>
...
<a class="anchor1" href="<?php echo $url; ?>" style="    width: 167px;
		...
		<div class="container-fluid jkl" >
			<div class="col-md-12 njk"></div>
				<div class="container bor">
					...
					<h2 style="font-family: 'Great Vibes', cursive;color: black;text-transform: capitalize; font-size: 36px;"><?php echo $data['category']; ?></h2>
					<h1 style="text-align: center;"><a  style="color: black;" href="<?php echo $url; ?>"><?php echo $data["heading"]; ?> </a> </h1>
					<br>
					<p>	<?php echo $data["short_des"]; ?> </p>
					<br>
    ...
    text-decoration: none;"> Read More...</a>
					...
					<div class="col-md-6 small1">
						<img src="<?php echo $data["d_image"]; ?>" style="height: 350px;" height="350px;" width="100%">	
							<div class="shape9">
									<?php echo $day; ?><br>
									<?php echo $month; ?><br>
									<?php echo $year; ?>
