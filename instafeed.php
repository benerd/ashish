...
/* Body for this page */
body{margin:0 auto;}
.nav {background:white;color:black;height:80px;}
...
#ody li{width:20%;display:inline-block;position:relative;margin:0!important;padding:0px!important;float:left}
#ody li:nth-child(1){width:20%}
...
#instagridz.widget.insta h2.title p{display:inline-block;background:#000;padding:0px;position:relative}}
</style>
...
<div class='instagrid section' id='Instagram'>
	<div class='instagrid.css' data-version='1' id='instagridz'>
		...
		<div class='instagrid.css'>
						...
						accessToken:"3603888899.e98809b.743f3943742842e9ad6968db7a74415a"
						});feed.run();
						</script>
			<div id='ody'></div>
		</div>
