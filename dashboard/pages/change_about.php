...
if($x){
	$qry=mysqli_query($con, "insert into img_db set img='$url', type=1 ");

	if($qry){
		header("location:change_about.php?m=2");
	}
	else
	{
		header("location:change_about.php?m=3");
	}
}

else{
	header("location:change_about.php?m=1");
}
}
