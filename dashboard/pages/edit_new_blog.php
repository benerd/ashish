...
if($x9)
{
  ...
  $qry=mysqli_query($con, "update blogs set category='$cat', heading='$head', short_des='$short',	content='$cont', image='$url', posted_on='$posted_on', posted_by='$posted_by', is_toppost=$top, banner_image='$url3', image_2='$url1', image_3='$url2', d_image='$url4', img4='$url5', img5='$url6', img6='$url7', img7='$url8', img8='$url9'  where id=$id");
  ...
  {
  	error_log("error while editing blogs");
